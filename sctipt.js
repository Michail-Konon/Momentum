...
// предполагается сох-ранение настроек сокрытия через локальное хранилище и флаги isHide 
// для каждого элемента. При загрузке страницы происходит проверка для каждого блока
// на основе проверки добавляется класс timeToHide
